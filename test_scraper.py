...
def test_get_data_tile_paths_single_tile():
    ...
    assert len(paths) == 1
    assert paths[0] == "data/x000/x000/000"
...
def test_get_data_tile_paths_adjacent_tiles():
    ...
    assert len(paths) == 2
    assert paths[0] == "data/x000/x000/000"
    assert paths[1] == "data/x000/x000/001"
...
def test_get_data_tile_paths_multiple_tiles():
    ...
    assert len(paths) == 4
    assert paths[0] == "data/x000/x000/005"
    assert paths[1] == "data/x000/x000/006"
    assert paths[2] == "data/x000/x000/007"
    assert paths[3] == "data/x000/x000/008"
