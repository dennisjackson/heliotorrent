...
if __name__ == "__main__":
    ...
    parser.add_argument('--frequency',type=int,help="How often to run in seconds",default=300)
    parser.add_argument('--entry-limit',type=int,help="Maximum number of entries to fetch",default=None)
